 ...
 * - added module loading via the load_fake_gralloc function
 * - removed dependency to sync/sync.h and made stubs of the
 *   lockAsync and lockAsyncYCbCr functions
 *
 */
...
#ifndef __ANDROID__
#include "gralloc/fake_gralloc.h"
#else
